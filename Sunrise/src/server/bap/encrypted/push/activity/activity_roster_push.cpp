...
bool append_roster_notification(
    ...
    // Lifetime 4 holds the loading presentation. Release it when the region is instantiated;
    // awaitClientSync keeps the spawn held until the independent world-arrival report.
